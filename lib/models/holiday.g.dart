...
extension HolidayByIndex on IsarCollection<Holiday> {
  Future<Holiday?> getByDate(DateTime date) {
    return getByIndex(r'date', [date]);
  }

  Holiday? getByDateSync(DateTime date) {
  ...
  Future<List<Holiday?>> getAllByDate(List<DateTime> dateValues) {
    final values = dateValues.map((e) => [e]).toList();
    return getAllByIndex(r'date', values);
  }

  List<Holiday?> getAllByDateSync(List<DateTime> dateValues) {
    final values = dateValues.map((e) => [e]).toList();
  ...
  Future<Id> putByDate(Holiday object) {
    return putByIndex(r'date', object);
  }

  Id putByDateSync(Holiday object, {bool saveLinks = true}) {
    return putByIndexSync(r'date', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByDate(List<Holiday> objects) {
    return putAllByIndex(r'date', objects);
  }

  List<Id> putAllByDateSync(List<Holiday> objects, {bool saveLinks = true}) {
...
extension HolidayQueryWhereSort on QueryBuilder<Holiday, Holiday, QWhere> {
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension HolidayQueryWhere on QueryBuilder<Holiday, Holiday, QWhereClause> {
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhereClause> dateEqualTo(DateTime date) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhereClause> dateNotEqualTo(
      DateTime date) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhereClause> dateGreaterThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhereClause> dateLessThan(
    DateTime date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Holiday, Holiday, QAfterWhereClause> dateBetween(
    DateTime lowerDate,
    DateTime upperDate, {
    bool includeLower = true,
    bool includeUpper = true,
